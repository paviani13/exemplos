 ...
 */
public class BlueFragment extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button btnOpenRed = (Button) root.findViewById(R.id.btnOpenRed);
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onFragmentInteractionBlue(uri);
        }
    }
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnBlueFragmentInteractionListener) {
            ...
            throw new RuntimeException(context.toString()
                    + " must implement OnBlueFragmentInteractionListener");
        }
    }
    ...
    public interface OnBlueFragmentInteractionListener {
        ...
        void onFragmentInteractionBlue(Uri uri);
    }
}
