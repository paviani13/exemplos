...
public class RedFragment extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button btnOpenBlue = (Button) root.findViewById(R.id.btnOpenGreen);
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onFragmentInteractionRed(uri);
        }
    }
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnRedFragmentInteractionListener) {
            mListener = (OnRedFragmentInteractionListener) context;
        } else {
            throw new RuntimeException(context.toString()
                    + " must implement OnRedFragmentInteractionListener");
        }
    }
    ...
    public interface OnRedFragmentInteractionListener {
        ...
        void onFragmentInteractionRed(Uri uri);
    }
}
